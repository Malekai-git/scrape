...
def scrape_salary():
    ...
    for salary_match in salaries:
        currency = salary_match[1] if salary_match[1] else 'Unknown'
        min_salary = salary_match[2] if salary_match[2] else 'Unknown'
        max_salary = salary_match[3] if salary_match[3] else 'Unknown'
